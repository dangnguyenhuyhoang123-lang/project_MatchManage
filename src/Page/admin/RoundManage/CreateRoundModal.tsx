...
export default function CreateRoundModal({
  ...
  const handleChange = (
    ...
    setRound((prev) => {
      ...
      if (name === "seasonId") {
        ...
        next.seasonName =
          seasons.find((season) => season.id === parsedSeasonId)?.displayName ??
          null;
        return next;
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!round.startDate)
      nextErrors.startDate = "Vui lòng chọn thời gian bắt đầu.";
    if (!round.endDate)
      nextErrors.endDate = "Vui lòng chọn thời gian kết thúc.";
