...
const PlayerManagement: React.FC = () => {
  ...
  const filterPlayersOnClient = (players: Player[], filters: FilterState) => {
    ...
    return players.filter((player) => {
      const matchesSearch =
        !keyword ||
        normalizeSearchText(player.name).includes(keyword) ||
        normalizeSearchText(player.idCode).includes(keyword) ||
        normalizeSearchText(player.shirtNumber).includes(keyword) ||
        normalizeSearchText(player.nationality).includes(keyword) ||
        normalizeSearchText(getPlayerTeamName(player)).includes(keyword);
      ...
      const matchesStatus =
        ...
        normalizeSearchText(player.status) ===
