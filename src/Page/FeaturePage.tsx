                ...
                <div className="max-w-360 mx-auto px-6 md:px-12">
                    <section className="mb-16 text-center max-w-4xl mx-auto">
                        ...
                        <p className="text-gray-500 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
                            Nâng tầm quản lý bóng đá chuyên nghiệp với hệ sinh thái công
                            nghệ hiện đại, được thiết kế để tối ưu hóa mọi khía cạnh từ sân
                            cỏ đến văn phòng điều hành.
                        </p>
                    </section>
                        ...
                        <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-sm border border-gray-100/50 flex flex-col justify-between overflow-hidden">
                            <div>
                                ...
                                <p className="text-gray-500 text-lg leading-relaxed mb-12">
                                    Mọi diễn biến trên sân được cập nhật tức thì. Theo dõi chỉ
                                    số cầu thủ, tỷ lệ kiểm soát bóng và bản đồ nhiệt ngay khi
                        ...
                        <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-sm border border-gray-100/50 flex flex-col justify-between overflow-hidden">
                            <div>
                                ...
                                <p className="text-gray-500 text-lg leading-relaxed mb-8">
                                    Hệ thống AI phân tích chuyên sâu phong độ cầu thủ và tài
                                    chính câu lạc bộ. Xuất báo cáo trực quan dưới dạng PDF hoặc
                                    tương tác trực tiếp.
                                </p>
                            </div>
                    ...
                    <section className="mb-24 px-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 leading-relaxed">
                                    Truy cập dữ liệu từ bất kỳ thiết bị nào với tốc độ đồng bộ
                                    hóa tức thì.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 leading-relaxed">
                                    Tích hợp đăng ký, quản lý hồ sơ và thanh toán hội phí tự
                                    động.
                                </p>
                            </div>
                        </div>
